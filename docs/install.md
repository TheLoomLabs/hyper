...
Anywhere else that build reports what it honestly is — `0.0.4-alpha+dirty` from an edited tree,
...
```bash
go build -ldflags "-X github.com/TheLoomLabs/hyper/internal/version.Version=0.0.4-alpha" \
