...
// depth: such a Step Refuses on any Run given no Secret sink, and the
// workflow project generates supplies none and cannot sensibly be made to,
// so where a Cadence carries it the Refusal lands at every occurrence and
// the Procedure works never (§4, §5, ADR-0077, ADR-0148,
// issues #96, #270). It is its own code rather than a
