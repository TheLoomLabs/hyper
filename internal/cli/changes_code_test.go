...
func TestCodeMoved_EveryClassEmitsOneRowPerSubjectAndFact(t *testing.T) {
	...
	want := strings.Join([]string{
		...
		"                                                         :00 is the executor's busiest minute — delivery there is likeliest to be delayed or dropped  :00 is the executor's busiest minute — delivery there is likeliest to be delayed or dropped",
